...
function CoinflowPurchaseHistory(props) {
    ...
    var iframeProps = (0, react_1.useMemo)(function () {
        ...
        return tslib_1.__assign(tslib_1.__assign({}, props), { walletPubkey: walletPubkey, route: "/history/purchase/".concat(props.merchantId), transaction: undefined, handleHeightChangeId: handleHeightChangeId });
