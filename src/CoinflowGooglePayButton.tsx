...
} from './MobileWalletButton';

export function CoinflowGooglePayButton(
  ...
  return (
    <MobileWalletButton
      ...
      alignItems={'center'}
    >
      <GooglePayLogo color={props.color} />
    </MobileWalletButton>
  );
}

function GooglePayLogo({color}: Pick<MobileWalletButtonProps, 'color'>) {
  if (color === 'white') {
    return <GooglePayLogoLight />;
  } else {
    return <GooglePayLogoDark />;
  }
}
